function InfoWeather({ name, temp }: { name: string; temp: number }) {
  return (
    <>
      <div className="px-8 absolute inset-x-0 bottom-0 h-1/2 flex flex-col justify-evenly">
        <div className="flex flex-col items-center justify-center w-full  text-slate-300  ">
          {/* Component Start */}
            ...
            <div className="flex justify-between">
              <div className="flex flex-col">
                <span className="text-6xl font-bold">
                  ...
                  {Math.floor(temp / 27)}°C
                </span>
                <span className="font-semibold mt-1 text-gray-500">{name}</span>
              </div>
              <svg
